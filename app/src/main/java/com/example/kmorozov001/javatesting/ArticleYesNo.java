...
public class ArticleYesNo extends AppCompatActivity  implements View.OnClickListener{
    TextView text;
    Button ok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_article_yes_no);

        text = (TextView)findViewById(R.id.textview);
        // загружаем текст
        text.setText(Html.fromHtml(yesNo.article));
    ...
    public void onClick(View v) {
        Intent intent = new Intent(ArticleYesNo.this, MainActivity.class);
