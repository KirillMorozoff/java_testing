...
public class ArticleActivityTypeIn extends AppCompatActivity implements View.OnClickListener {
    TextView text;
    Button ok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // загружаем текст
        text.setText(Html.fromHtml(typeInActivity.article));
    ...
    public void onClick(View v) {
        Intent intent = new Intent(ArticleActivityTypeIn.this, yesNo.class);
